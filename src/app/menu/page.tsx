 ...
 return (
  <div className="container mx-auto px-4 py-8">
   <div className="mb-8 text-center">
    <h1 className="text-4xl font-bold mb-2 bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">Our menu</h1>
    <p className="text-xl text-gray-600">We have a Wide Range of Menu</p>
   </div>
